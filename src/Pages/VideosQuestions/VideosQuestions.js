...
import VideosQuestionsTableList from "./VideosQuestionsTableList/VideosQuestionsTableList";
// import CourseListTable from "../CourseTable/courseListTable";

const VideosQuestions = () => {
  ...
  const getQuestions = () => {
    const data_send = {
      course_video_id: course_id, //
      type: "videos",
    };

    axios
      .post(
        "https://camp-coding.tech/quest/platform/admin/students/select_students_questions.php",
  ...
  const handleaddexam = () => {
    ...
    axios
      .post(
        "https://camp-coding.tech/quest/platform/admin/Exams/insert_exam.php",
  ...
  const hanldeassign = () => {
    ...
    axios
      .post(
        "https://camp-coding.tech/quest/platform/admin/Exams/assign_exam_to_course.php",
        JSON.stringify(data_send)
      )
      .then((res) => {
        if (res.status == "success") {
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Questions" breadcrumbItem="Questions List" />
...
export default VideosQuestions;
