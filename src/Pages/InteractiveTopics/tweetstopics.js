...
const TopicTweets = ({ allunitdata, cd }) => {
  ...
  const getTweets = async () => {
    ...
    const get = await axios.post(
      "https://camp-coding.tech/quest/platform/admin/tweets/topics/select_unit_tweets.php",
      data_send
    );
    setTweets(get?.message?.tweets);
    setItemLoader(false);
  };
  ...
  const columns = [
    ...
    },
    {
      ...
      Cell: (cell) => {
        if (
          permissions?.includes("*8_2") ||
          permissions?.startsWith("8_2") ||
          permissions == "all"
        )
          ...
          <>
            <UncontrolledDropdown>
              ...
              <DropdownMenu className="dropdown-menu-end">
                ...
                {permissions?.includes("*8_3") ||
                permissions?.startsWith("8_3") ||
                permissions == "all" ? (
                  <DropdownItem
                    onClick={() => {
                      setsetShowCopy(true);
  ...
  return (
    <React.Fragment>
      <Container fluid={true}>
        <Breadcrumbs title={""} breadcrumbItem={" > Tweets List"} />
              ...
              <CardBody>
                ...
                <div id="table-invoices-list">
                  {itemLoader ? (
                    ...
                    <>
                      {Array.isArray(tweets) && tweets.length ? (
                        <TweetsTableList
