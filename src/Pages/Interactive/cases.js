...
const Cases = ({ CourseId, allunitdata, unitId, cd }) => {
  ...
  const getQuestions = async () => {
    ...
    const get = await axios.post(
      "https://camp-coding.tech/quest/platform/admin/cases/select_cases.php",
      data_send
    );
  ...
  const handlecopyitem = (data) => {
    ...
    axios
      .post(
        "https://camp-coding.tech/quest/platform/admin/cases/make_copy_from_case.php",
